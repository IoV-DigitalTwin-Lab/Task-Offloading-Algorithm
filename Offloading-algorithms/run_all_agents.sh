...
# configs/redis_config.json and/or your simulation config.
# Loaded from .env when present; fallback is applied after .env sourcing.
REDIS_DBS=()
...
# Load overrides from a local .env if present so the script and environment
# file stay in sync.
